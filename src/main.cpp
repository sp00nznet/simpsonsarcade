...
static LONG WINAPI fp_exception_handler(EXCEPTION_POINTERS* ep)
{
    ...
    if (code >= 0xC000008D && code <= 0xC0000093)
    {
        _clearfp();
...
// Forward-declare the XEX entry point (generated by XenonRecomp)
...
int main(int argc, char* argv[])
{
    ...
    printf("=== The Simpsons Arcade - Static Recompilation ===\n\n");
    ...
    printf("\n[4/5] Creating window...\n");
    {
        ...
        wc.lpszClassName = "SimpsonsWndClass";
        RegisterClassExA(&wc);
        ...
        g_hwnd = CreateWindowExA(
            0, "SimpsonsWndClass", "The Simpsons Arcade",
            WS_OVERLAPPEDWINDOW,
    ...
    // Convert main thread to fiber for cooperative threading
